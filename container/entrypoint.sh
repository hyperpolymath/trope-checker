...
# Trope Checker container entrypoint
#
...
cleanup() {
    echo "Received shutdown signal — stopping trope-checker..."
...
# Examples:
#   exec /app/trope-checker
#   exec /app/release/bin/trope-checker start
#   exec /app/trope-checker serve --host "${APP_HOST}" --port "${APP_PORT}"
