...
= Contributing — Trope Checker
:revdate: 2026-MM-DD

== Audience

Developers working *on* `Trope Checker`. For consumers (people calling
...
[source,bash]
----
git clone git@github.com:hyperpolymath/Trope Checker.git
cd Trope Checker
...
* Bugs in `Trope Checker`: file at `hyperpolymath/Trope Checker/issues`.
